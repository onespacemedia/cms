...
* `section`: The closest element to the homepage in the tree. In our example above, this would be "Cat treats". If `pages.current` was "Cat treats", it would be "Cat treats" again. If the current page is the homepage, it would be `None`.
