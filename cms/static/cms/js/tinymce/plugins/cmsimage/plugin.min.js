        ...
        body: [
          {
            ...
            items: [
              {
                type: 'container',
                html: '<div class="media-gallery-container" style="padding: 10px; background: #FFF; height: 480px;"><iframe src="/admin/media/file/?_popup=1&file__iregex=.(png|gif|jpg|jpeg)$"></iframe></div>'
              }
            ]
          },
          {
