    ...
    if ($this.length && showAddButton) {
      ...
      if (addButton === null) {
        if ($this.prop("tagName") === "TR") {
          ...
          $parent.append('<tr class="' + options.addCssClass + '"><td colspan="' + numCols + '"><a href="#" class="btn btn-info">' + options.addText + "</a></tr>");
          addButton = $parent.find("tr:last a");
        } else {
          // Otherwise, insert it immediately after the last form:
          $this.filter(":last").after('<div class="' + options.addCssClass + '"><a href="#" class="btn btn-info">' + options.addText + "</a></div>");
